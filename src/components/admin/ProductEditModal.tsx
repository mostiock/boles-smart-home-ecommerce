...
import type { DatabaseProduct } from "@/lib/database";
...
interface ProductEditModalProps {
  ...
  isOpen: boolean;
  onClose: () => void;
  onSave: (productId: string, updates: Partial<DatabaseProduct>) => void;
}
...
export function ProductEditModal({
  ...
  const [formData, setFormData] = useState<Partial<DatabaseProduct>>({});
  ...
  const handleInputChange = (field: keyof DatabaseProduct, value: unknown) => {
    setFormData((prev) => ({
      ...prev,
      [field]: value,
    }));
